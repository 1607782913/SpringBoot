...
public class XueshengzuoyeController {
    ...
    public R page(@RequestParam Map<String, Object> params,XueshengzuoyeEntity xueshengzuoye,
		...
		if(tableName.equals("jiazhang")) {
			xueshengzuoye.setJiazhangzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("jiaoshi")) {
			xueshengzuoye.setJiaoshizhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<XueshengzuoyeEntity> wrapper = new EntityWrapper<XueshengzuoyeEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = xueshengzuoyeService.selectCount(wrapper);
