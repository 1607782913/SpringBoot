<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">中小学家校通系统的设计与实现注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">教师账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiaoshizhanghao" class="input" type="text" placeholder="教师账号">
			   </div>
			 </div> -->
			<el-form-item label="教师账号" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.jiaoshizhanghao" autocomplete="off" placeholder="教师账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			...
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">教师电话</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiaoshidianhua" class="input" type="text" placeholder="教师电话">
			   </div>
			 </div> -->
			<el-form-item label="教师电话" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.jiaoshidianhua" autocomplete="off" placeholder="教师电话"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			...
			<!-- <div v-if="tableName=='jiazhang'" class="input-group">
			   <div class="label">家长账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiazhangzhanghao" class="input" type="text" placeholder="家长账号">
			   </div>
			 </div> -->
			<el-form-item label="家长账号" class="input" v-if="tableName=='jiazhang'">
			  <el-input v-model="ruleForm.jiazhangzhanghao" autocomplete="off" placeholder="家长账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiazhang'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='jiazhang'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='jiazhang'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<!-- <div v-if="tableName=='jiazhang'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.jiazhangxingming" class="input" type="text" placeholder="家长姓名">
			   </div>
			 </div> -->
			<el-form-item label="家长姓名" class="input" v-if="tableName=='jiazhang'">
			  <el-input v-model="ruleForm.jiazhangxingming" autocomplete="off" placeholder="家长姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiazhang'" class="input-group">
			   <div class="label">家长电话</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiazhangdianhua" class="input" type="text" placeholder="家长电话">
			   </div>
			 </div> -->
			<el-form-item label="家长电话" class="input" v-if="tableName=='jiazhang'">
			  <el-input v-model="ruleForm.jiazhangdianhua" autocomplete="off" placeholder="家长电话"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiazhang'" class="input-group">
			...
			<el-form-item label="学生姓名" class="input" v-if="tableName=='jiazhang'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if(`jiaoshi` == this.tableName && this.ruleForm.jiaoshidianhua&&(!this.$validate.isMobile(this.ruleForm.jiaoshidianhua))){
