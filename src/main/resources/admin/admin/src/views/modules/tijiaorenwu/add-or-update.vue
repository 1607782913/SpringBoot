<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="家长电话" prop="jiazhangdianhua">
          <el-input v-model="ruleForm.jiazhangdianhua" 
              placeholder="家长电话" clearable  :readonly="ro.jiazhangdianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="家长电话" prop="jiazhangdianhua">
              <el-input v-model="ruleForm.jiazhangdianhua" 
                placeholder="家长电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="任务编号" prop="renwubianhao">
            <el-input v-model="ruleForm.renwubianhao" 
                placeholder="任务编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.renwubianhao" label="任务编号" prop="renwubianhao">
              <el-input v-model="ruleForm.renwubianhao" 
                placeholder="任务编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.wanneirong" label="完内容" prop="wanneirong">
          <file-upload
          tip="点击上传完内容"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.wanneirong?ruleForm.wanneirong:''"
          @change="wanneirongUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.wanneirong" label="完内容" prop="wanneirong">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.wanneirong.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教师账号" prop="jiaoshizhanghao">
          <el-input v-model="ruleForm.jiaoshizhanghao" 
              placeholder="教师账号" clearable  :readonly="ro.jiaoshizhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教师账号" prop="jiaoshizhanghao">
              <el-input v-model="ruleForm.jiaoshizhanghao" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="任务要求" prop="renwuyaoqiu">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.renwuyaoqiu" label="任务要求" prop="renwuyaoqiu">
                    <span v-html="ruleForm.renwuyaoqiu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiazhangxingming = true;
          ...
          if(o=='jiazhangdianhua'){
            this.ruleForm.jiazhangdianhua = obj[o];
	    this.ro.jiazhangdianhua = true;
            continue;
          }
          if(o=='renwubianhao'){
            this.ruleForm.renwubianhao = obj[o];
	    this.ro.renwubianhao = true;
            continue;
          }
          if(o=='renwubiaoti'){
	    ...
	    this.ro.renwuyaoqiu = true;
          ...
          if(o=='wanneirong'){
            this.ruleForm.wanneirong = obj[o];
	    this.ro.wanneirong = true;
            continue;
          }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.jiazhangzhanghao!=''&&json.jiazhangzhanghao){
                this.ruleForm.jiazhangzhanghao = json.jiazhangzhanghao
	    		this.ro.jiazhangzhanghao = true;
		}
		if(json.jiazhangxingming!=''&&json.jiazhangxingming){
                this.ruleForm.jiazhangxingming = json.jiazhangxingming
	    		this.ro.jiazhangxingming = true;
		}
		if(json.jiazhangdianhua!=''&&json.jiazhangdianhua){
                this.ruleForm.jiazhangdianhua = json.jiazhangdianhua
	    		this.ro.jiazhangdianhua = true;
		}
        } else {
	...
	this.ruleForm.renwuyaoqiu = this.ruleForm.renwuyaoqiu.replace(reg,'../../../springboot7z6vr/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.wanneirong!=null) {
		this.ruleForm.wanneirong = this.ruleForm.wanneirong.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `tijiaorenwu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.tijiaorenwuCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    wanneirongUploadChange(fileUrls) {
	this.ruleForm.wanneirong = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
