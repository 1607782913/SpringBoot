<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="家长账号" prop="jiazhangzhanghao">
          <el-select :disabled="ro.jiazhangzhanghao" @change="jiazhangzhanghaoChange" v-model="ruleForm.jiazhangzhanghao" placeholder="请选择家长账号">
            <el-option
                v-for="(item,index) in jiazhangzhanghaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.jiazhangzhanghao" label="家长账号" prop="jiazhangzhanghao">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="作业标题" prop="zuoyebiaoti">
          <el-input v-model="ruleForm.zuoyebiaoti" 
              placeholder="作业标题" clearable  :readonly="ro.zuoyebiaoti"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.zuoyeneirong" label="作业内容" prop="zuoyeneirong">
          <file-upload
          tip="点击上传作业内容"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zuoyeneirong" label="作业内容" prop="zuoyeneirong">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.zuoyeneirong)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="提交时间时间" prop="tijiaoshijianshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.tijiaoshijianshijian" 
                type="date"
                :readonly="ro.tijiaoshijianshijian"
                placeholder="提交时间时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tijiaoshijianshijian" label="提交时间时间" prop="tijiaoshijianshijian">
              <el-input v-model="ruleForm.tijiaoshijianshijian" 
                placeholder="提交时间时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
...
export default {
  data() {
	...
	fengmian : false,
      ...
      ruleForm: {
        ...
        zuoyeneirong: '',
        shifouhege: '',
        tijiaoshijianshijian: '',
        fengmian: '',
      },
          jiazhangzhanghaoOptions: [],
          shifouhegeOptions: [],
      rules: {
          jiazhangzhanghao: [
          ],
  ...
  created() {
	this.ruleForm.tijiaoshijianshijian = this.getCurDate()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shifouhege = true;
          ...
          if(o=='tijiaoshijianshijian'){
            this.ruleForm.tijiaoshijianshijian = obj[o];
	    this.ro.tijiaoshijianshijian = true;
            continue;
          }
          if(o=='fengmian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.jiaoshizhanghao!=''&&json.jiaoshizhanghao){
		...
		if(json.jiaoshixingming!=''&&json.jiaoshixingming){
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                this.jiazhangzhanghaoOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
