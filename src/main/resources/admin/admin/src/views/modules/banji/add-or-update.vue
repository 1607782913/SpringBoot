<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="班级人数" prop="banjirenshu">
          <el-input v-model="ruleForm.banjirenshu" 
              placeholder="班级人数" clearable  :readonly="ro.banjirenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="班级人数" prop="banjirenshu">
              <el-input v-model="ruleForm.banjirenshu" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="班主任姓名" prop="banzhurenxingming">
          <el-select :disabled="ro.banzhurenxingming" @change="banzhurenxingmingChange" v-model="ruleForm.banzhurenxingming" placeholder="请选择班主任姓名">
            <el-option
                v-for="(item,index) in banzhurenxingmingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.banzhurenxingming" label="班主任姓名" prop="banzhurenxingming">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教师电话" prop="jiaoshidianhua">
          <el-input v-model="ruleForm.jiaoshidianhua" 
              placeholder="教师电话" clearable  :readonly="ro.jiaoshidianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教师电话" prop="jiaoshidianhua">
              <el-input v-model="ruleForm.jiaoshidianhua" 
                placeholder="教师电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.banzhurenxingming = true;
          ...
          if(o=='jiaoshidianhua'){
            this.ruleForm.jiaoshidianhua = obj[o];
	    this.ro.jiaoshidianhua = true;
            continue;
          }
        }
      }
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                this.banzhurenxingmingOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    // 下二随
    banzhurenxingmingChange () {
      this.$http({
        url: `follow/jiaoshi/jiaoshixingming?columnValue=`+ this.ruleForm.banzhurenxingming,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              if(data.data.jiaoshidianhua){
                this.ruleForm.jiaoshidianhua = data.data.jiaoshidianhua
              }
        } else {
          this.$message.error(data.msg);
        }
