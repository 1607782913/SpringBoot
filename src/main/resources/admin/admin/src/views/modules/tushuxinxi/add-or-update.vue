<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="简述" prop="jianshu">
          <el-input v-model="ruleForm.jianshu" 
              placeholder="简述" clearable  :readonly="ro.jianshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="简述" prop="jianshu">
              <el-input v-model="ruleForm.jianshu" 
                placeholder="简述" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../springboot7z6vr/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
