<template>
  <div>
    ...
    >  
     <el-row>
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="教师账号" prop="jiaoshizhanghao">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiazhang'"  label="家长电话" prop="jiazhangdianhua">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiazhang'"  label="学生姓名" prop="xueshengxingming">
          <el-input v-model="ruleForm.xueshengxingming"               placeholder="学生姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='jiazhang'"  label="班级" prop="banji">
          <el-select v-model="ruleForm.banji"  placeholder="请选择班级">
            <el-option
                v-for="(item,index) in jiazhangbanjiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
...
export default {
  ...
  mounted() {
    ...
    this.$http({
      ...
      if (data && data.code === 0) {
        this.jiazhangbanjiOptions = data.data;
      } else {
        this.$message.error(data.msg);
      }
    });
